...
// checks if the GetPnLRankingResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPnLRankingResponse{}
...
type _GetPnLRankingResponse GetPnLRankingResponse
...
func (o GetPnLRankingResponse) MarshalJSON() ([]byte, error) {
...
func (o GetPnLRankingResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GetPnLRankingResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetPnLRankingResponse := _GetPnLRankingResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetPnLRankingResponse)

	if err != nil {
		return err
	}

	*o = GetPnLRankingResponse(varGetPnLRankingResponse)

	return err
}

type NullableGetPnLRankingResponse struct {
	value *GetPnLRankingResponse
	isSet bool
}

func (v NullableGetPnLRankingResponse) Get() *GetPnLRankingResponse {
	return v.value
}

func (v *NullableGetPnLRankingResponse) Set(val *GetPnLRankingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPnLRankingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPnLRankingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPnLRankingResponse(val *GetPnLRankingResponse) *NullableGetPnLRankingResponse {
	return &NullableGetPnLRankingResponse{value: val, isSet: true}
}

func (v NullableGetPnLRankingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPnLRankingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
