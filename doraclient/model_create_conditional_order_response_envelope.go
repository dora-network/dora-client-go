...
// checks if the CreateConditionalOrderResponseEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateConditionalOrderResponseEnvelope{}
...
type _CreateConditionalOrderResponseEnvelope CreateConditionalOrderResponseEnvelope
...
func NewCreateConditionalOrderResponseEnvelope(metadata Metadata) *CreateConditionalOrderResponseEnvelope {
	this := CreateConditionalOrderResponseEnvelope{}
...
func (o CreateConditionalOrderResponseEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CreateConditionalOrderResponseEnvelope) ToMap() (map[string]interface{}, error) {
...
func (o *CreateConditionalOrderResponseEnvelope) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateConditionalOrderResponseEnvelope := _CreateConditionalOrderResponseEnvelope{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateConditionalOrderResponseEnvelope)

	if err != nil {
		return err
	}

	*o = CreateConditionalOrderResponseEnvelope(varCreateConditionalOrderResponseEnvelope)

	return err
}

type NullableCreateConditionalOrderResponseEnvelope struct {
	value *CreateConditionalOrderResponseEnvelope
	isSet bool
}

func (v NullableCreateConditionalOrderResponseEnvelope) Get() *CreateConditionalOrderResponseEnvelope {
	return v.value
}

func (v *NullableCreateConditionalOrderResponseEnvelope) Set(val *CreateConditionalOrderResponseEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateConditionalOrderResponseEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateConditionalOrderResponseEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateConditionalOrderResponseEnvelope(val *CreateConditionalOrderResponseEnvelope) *NullableCreateConditionalOrderResponseEnvelope {
	return &NullableCreateConditionalOrderResponseEnvelope{value: val, isSet: true}
}

func (v NullableCreateConditionalOrderResponseEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateConditionalOrderResponseEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
