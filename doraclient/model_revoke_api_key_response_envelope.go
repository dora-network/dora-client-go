...
// checks if the RevokeAPIKeyResponseEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevokeAPIKeyResponseEnvelope{}
...
type _RevokeAPIKeyResponseEnvelope RevokeAPIKeyResponseEnvelope
...
func NewRevokeAPIKeyResponseEnvelope(metadata Metadata) *RevokeAPIKeyResponseEnvelope {
	this := RevokeAPIKeyResponseEnvelope{}
...
func (o RevokeAPIKeyResponseEnvelope) MarshalJSON() ([]byte, error) {
...
func (o RevokeAPIKeyResponseEnvelope) ToMap() (map[string]interface{}, error) {
...
func (o *RevokeAPIKeyResponseEnvelope) UnmarshalJSON(data []byte) (err error) {
	...
	varRevokeAPIKeyResponseEnvelope := _RevokeAPIKeyResponseEnvelope{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRevokeAPIKeyResponseEnvelope)

	if err != nil {
		return err
	}

	*o = RevokeAPIKeyResponseEnvelope(varRevokeAPIKeyResponseEnvelope)

	return err
}

type NullableRevokeAPIKeyResponseEnvelope struct {
	value *RevokeAPIKeyResponseEnvelope
	isSet bool
}

func (v NullableRevokeAPIKeyResponseEnvelope) Get() *RevokeAPIKeyResponseEnvelope {
	return v.value
}

func (v *NullableRevokeAPIKeyResponseEnvelope) Set(val *RevokeAPIKeyResponseEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableRevokeAPIKeyResponseEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableRevokeAPIKeyResponseEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRevokeAPIKeyResponseEnvelope(val *RevokeAPIKeyResponseEnvelope) *NullableRevokeAPIKeyResponseEnvelope {
	return &NullableRevokeAPIKeyResponseEnvelope{value: val, isSet: true}
}

func (v NullableRevokeAPIKeyResponseEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRevokeAPIKeyResponseEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
