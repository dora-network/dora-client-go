...
// checks if the PositionAccounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PositionAccounts{}
...
func (v NullablePositionAccounts) IsSet() bool {
	return v.isSet
}

func (v *NullablePositionAccounts) Unset() {
	v.value = nil
	v.isSet = false
}
...
func (v NullablePositionAccounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePositionAccounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
