...
type _FundUserResponseEnvelope FundUserResponseEnvelope
...
func (o *FundUserResponseEnvelope) UnmarshalJSON(data []byte) (err error) {
	...
	varFundUserResponseEnvelope := _FundUserResponseEnvelope{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFundUserResponseEnvelope)

	if err != nil {
		return err
	}

	*o = FundUserResponseEnvelope(varFundUserResponseEnvelope)
