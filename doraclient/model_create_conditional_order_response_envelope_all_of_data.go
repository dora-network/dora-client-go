...
// checks if the CreateConditionalOrderResponseEnvelopeAllOfData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateConditionalOrderResponseEnvelopeAllOfData{}

// CreateConditionalOrderResponseEnvelopeAllOfData struct for CreateConditionalOrderResponseEnvelopeAllOfData
type CreateConditionalOrderResponseEnvelopeAllOfData struct {
...
func NewCreateConditionalOrderResponseEnvelopeAllOfData() *CreateConditionalOrderResponseEnvelopeAllOfData {
	this := CreateConditionalOrderResponseEnvelopeAllOfData{}
	return &this
}
...
func (o CreateConditionalOrderResponseEnvelopeAllOfData) MarshalJSON() ([]byte, error) {
...
func (o CreateConditionalOrderResponseEnvelopeAllOfData) ToMap() (map[string]interface{}, error) {
...
type NullableCreateConditionalOrderResponseEnvelopeAllOfData struct {
	value *CreateConditionalOrderResponseEnvelopeAllOfData
	isSet bool
}

func (v NullableCreateConditionalOrderResponseEnvelopeAllOfData) Get() *CreateConditionalOrderResponseEnvelopeAllOfData {
	return v.value
}

func (v *NullableCreateConditionalOrderResponseEnvelopeAllOfData) Set(val *CreateConditionalOrderResponseEnvelopeAllOfData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateConditionalOrderResponseEnvelopeAllOfData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateConditionalOrderResponseEnvelopeAllOfData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateConditionalOrderResponseEnvelopeAllOfData(val *CreateConditionalOrderResponseEnvelopeAllOfData) *NullableCreateConditionalOrderResponseEnvelopeAllOfData {
	return &NullableCreateConditionalOrderResponseEnvelopeAllOfData{value: val, isSet: true}
}

func (v NullableCreateConditionalOrderResponseEnvelopeAllOfData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateConditionalOrderResponseEnvelopeAllOfData) UnmarshalJSON(src []byte) error {
	v.isSet = true
