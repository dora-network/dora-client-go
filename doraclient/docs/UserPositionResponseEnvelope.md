...
------------ | ------------- | ------------- | -------------
**Data** | Pointer to [**PositionResponse**](PositionResponse.md) |  | [optional] 
...
`func NewUserPositionResponseEnvelope(metadata Metadata, ) *UserPositionResponseEnvelope`
...
`func (o *UserPositionResponseEnvelope) GetData() PositionResponse`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *UserPositionResponseEnvelope) GetDataOk() (*PositionResponse, bool)`
...
`func (o *UserPositionResponseEnvelope) SetData(v PositionResponse)`
